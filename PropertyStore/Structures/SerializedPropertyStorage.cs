...
namespace PropertyStore.Structures
{
    ...
    public class SerializedPropertyStorage : Structure
    {
        ...
        {
            this.PropertyStorage = new List<SerializedPropertyValue>();
        }
        ...
        /// </summary>
        public virtual UInt32 StorageSize
        {
            get
            {
                UInt32 Size = 28;
        ...
        /// </summary>
        public UInt32 Version => 0x53505331;
        ...
        public static SerializedPropertyStorage FromByteArray(byte[] ba)
        {
            ...
            UInt32 Version = BitConverter.ToUInt32(ba, 4);
